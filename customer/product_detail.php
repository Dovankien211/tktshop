...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_to_cart'])) {
    ...
    if (empty($kich_co) || $mau_sac_id == 0) {
        alert('Vui lòng chọn size và màu sắc!', 'warning');
    } else {
        ...
        if (!$selected_variant) {
            alert('Biến thể sản phẩm không tồn tại!', 'danger');
        } elseif ($selected_variant['so_luong_ton_kho'] < $so_luong) {
            alert('Không đủ hàng trong kho! Còn lại: ' . $selected_variant['so_luong_ton_kho'], 'warning');
        } else {
            // Thêm vào giỏ hàng
            ...
            try {
                ...
                if ($existing_item) {
                    ...
                    if ($new_quantity > $selected_variant['so_luong_ton_kho']) {
                        alert('Không đủ hàng trong kho! Tối đa có thể mua: ' . $selected_variant['so_luong_ton_kho'], 'warning');
                    } else {
                        $pdo->prepare("UPDATE gio_hang SET so_luong = ? WHERE id = ?")
                            ->execute([$new_quantity, $existing_item['id']]);
                        alert('Cập nhật số lượng sản phẩm trong giỏ hàng thành công!', 'success');
                    }
                } else {
                    ...
                    $pdo->prepare("
                        ...
                        VALUES (?, ?, ?, ?, NOW())
                    ")->execute([$customer_id, $session_id, $selected_variant['id'], $so_luong]);
                    alert('Thêm sản phẩm vào giỏ hàng thành công!', 'success');
                }
            } catch (Exception $e) {
                alert('Có lỗi xảy ra khi thêm vào giỏ hàng!', 'danger');
            }
        }
    }
}
...
// Nếu không có ảnh nào, tạo ảnh mặc định
...
<body>
    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="products.php?category=<?= $product['danh_muc_id'] ?>"><?= htmlspecialchars($product['ten_danh_muc']) ?></a></li>
            ...
            <div class="col-lg-6">
                <div class="product-gallery">
                    <div class="position-relative">
                        <img id="mainImage" 
                             src="/uploads/products/<?= $product_images[0] ?>" 
                ...
                <div class="product-info">
                    ...
                    <?php if ($product['tags']): ?>
                        <div class="product-tags">
                            <?php foreach (explode(',', $product['tags']) as $tag): ?>
                                <span class="product-tag"><?= trim(htmlspecialchars($tag)) ?></span>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <form method="POST" id="addToCartForm">
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            <button type="submit" name="add_to_cart" class="btn btn-primary btn-lg flex-grow-1" id="addToCartBtn" disabled>
                                ...
                                <div class="reviews-list">
                                    <?php foreach ($reviews as $review): ?>
                                        <div class="review-item">
                                            ...
                                            <?php if ($review['hinh_anh']): ?>
                                                <div class="review-images mb-2">
                                                    <?php
                                                    $review_images = json_decode($review['hinh_anh'], true);
                        ...
                        <?php foreach ($related_products as $related): ?>
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                                <div class="card h-100 product-card">
                                    <div class="position-relative">
                                        <img src="/uploads/products/<?= $related['hinh_anh_chinh'] ?: 'default-product.jpg' ?>" 
                                             class="card-img-top" 
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <h6 class="card-title">
                                            <a href="product_detail.php?slug=<?= $related['slug'] ?>" 
    ...
    <script>
        ...
        function changeMainImage(imageSrc, thumbnail) {
            document.getElementById('mainImage').src = '/uploads/products/' + imageSrc;
        ...
        function updateVariantInfo() {
            ...
            if (selectedSize && selectedColorId) {
                ...
                if (currentVariant) {
                    ...
                    const price = currentVariant.gia_ban;
        ...
        function addToWishlist(productId) {
            ...
            alert('Tính năng yêu thích sẽ được cập nhật sớm!');
        }
        
        // Load more reviews
        function loadMoreReviews() {
            // Implementation for loading more reviews via AJAX
            alert('Tính năng tải thêm đánh giá sẽ được cập nhật sớm!');
        }
