    ...
    if (empty($errors)) {
        try {
            ...
            if ($stmt->execute([$ten_dang_nhap, $hashed_password, $ho_ten, $email, $so_dien_thoai])) {
                ...
                redirect('/customer/login.php'); // SỬA LẠI ĐƯỜNG DẪN
            } else {
                    ...
                    <div class="register-card">
                        ...
                        <div class="register-body">
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="dong_y_dieu_khoan">
                                            Tôi đồng ý với 
                                            <a href="/tktshop/customer/terms.php" target="_blank" class="text-decoration-none">
                                                Điều khoản sử dụng
                                            </a> 
                                            và 
                                            <a href="/tktshop/customer/privacy.php" target="_blank" class="text-decoration-none">
                                                Chính sách bảo mật
                                            </a>
                                        </label>
                                    </div>
                            ...
                            <div class="text-center mt-4">
                                <p class="mb-0">
                                    Đã có tài khoản? 
                                    <a href="/tktshop/customer/login.php" class="text-decoration-none fw-bold">
                                        Đăng nhập ngay
                                    </a>
                                </p>
                            </div>
