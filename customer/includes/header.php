...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container">
        <!-- Logo -->
        <a class="navbar-brand fw-bold fs-3" href="/tktshop/">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : '' ?>" href="/tktshop/">
            ...
            <div class="d-flex align-items-center gap-3">
                <!-- Wishlist -->
                <a href="/tktshop/customer/wishlist.php" class="text-decoration-none position-relative" title="Danh sách yêu thích">
                    <i class="fas fa-heart fs-5 text-muted hover-primary"></i>
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" id="wishlist-count" style="font-size: 0.7rem;">
                        0
                    </span>
                </a>
                ...
                <?php if (isset($_SESSION['customer_id'])): ?>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="/tktshop/customer/profile.php">
                                <i class="fas fa-user me-2"></i>Thông tin cá nhân
                            </a></li>
                            <li><a class="dropdown-item" href="/tktshop/customer/orders.php">
                                <i class="fas fa-shopping-bag me-2"></i>Đơn hàng của tôi
                            </a></li>
                            <li><a class="dropdown-item" href="/tktshop/customer/wishlist.php">
                                <i class="fas fa-heart me-2"></i>Sản phẩm yêu thích
                            </a></li>
                            <li><a class="dropdown-item" href="/tktshop/customer/addresses.php">
                                <i class="fas fa-map-marker-alt me-2"></i>Sổ địa chỉ
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="/tktshop/customer/change_password.php">
...
document.querySelector('input[name="search"]').addEventListener('input', function() {
    ...
    // This would fetch popular search terms and product names
});
