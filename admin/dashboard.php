<?php
// admin/dashboard.php - ĐÃ SỬA LAYOUT VÀ THÊM SIDEBAR TOGGLE
/**
            ...
            <div class="card welcome-card mb-4">
                <div class="card-body py-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h2 class="mb-2">Chào mừng trở lại, <?= htmlspecialchars($_SESSION['admin_name'] ?? $_SESSION['user_name'] ?? 'Administrator') ?>!</h2>
                            <p class="mb-0">Vai trò: <span class="badge bg-light text-dark"><?= ($_SESSION['admin_role'] ?? $_SESSION['user_role'] ?? 'admin') == 'admin' ? 'Quản trị viên' : 'Nhân viên' ?></span></p>
